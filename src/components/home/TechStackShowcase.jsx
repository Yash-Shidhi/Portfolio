...
export const TechStackShowcase = () => {
  ...
  return (
    <section
      id="tech-stack"
      className={`py-16 px-4 ${isDark ? "bg-gray-950 text-white" : "bg-gray-50 text-gray-900"}`}
    >
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className={`rounded-xl p-6 shadow-lg transition-all duration-300 ${
            isDark ? "bg-gray-900 border border-indigo-700" : "bg-white border border-indigo-200"
          }`}
        >
